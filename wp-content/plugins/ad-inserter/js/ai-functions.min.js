...
function(a){setTimeout(function(){a instanceof Element&&a.classList.contains("ai-close")?d(a):a.querySelectorAll(".ai-close").forEach((b,c)=>{d(b)})},ai_close_button_delay)};"undefined"==typeof ai_close_button_delay&&(ai_close_button_delay=2200);ai_install_close_buttons(document)}
...
3);ai_process_check_recaptcha_score=function(){"undefined"!=typeof grecaptcha&&grecaptcha.ready(function(){grecaptcha.execute(ai_recaptcha_site_key,{action:"submit"}).then(function(c){var d=new XMLHttpRequest;c="ai_check=AI_NONCE&recaptcha="+c;d.open("POST",ai_ajax_url+"?action=ai_ajax",!0);d.setRequestHeader("Content-type","application/x-www-form-urlencoded");d.onreadystatechange=function(){if(4==this.readyState&&200==this.status){let e=JSON.parse(this.responseText);if(e&&e.success){ai_recaptcha_score=
...
0!=a.length&&(a[0].innerHTML=ai_front.hidden))}}else for(p({lazyClass:"ai-check-recaptcha-score",threshold:99999,observeChanges:!0,mutationObserverOptions:{childList:!0,attributes:!0,subtree:!0}}),b=0;b<k.length;b++)a=k[b].dataset.class,"undefined"!=typeof a&&(a=b64d(a),f=k[b].closest("."+a),null!=f&&(a=f.getElementsByClassName("ai-recaptcha-score"),0!=a.length&&(a[0].innerHTML=e.score),a=f.getElementsByClassName("ai-recaptcha-result"),0!=a.length&&(a[0].innerHTML=ai_front.visible)))}}};d.send(c)})})};
setTimeout(ai_process_check_recaptcha_score,2);ai_process_delayed_blocks=function(){var c=document.getElementsByClassName("ai-delayed-unprocessed");if(0!=c.length){function k(m){p({lazyClass:"ai-delayed-"+m,threshold:99999,observeChanges:!0,mutationObserverOptions:{childList:!0,attributes:!0,subtree:!0}})}for(var d=0;d<c.length;d++){element=c[d];for(var b=parseInt(element.getAttribute("data-delay")),a=parseInt(element.getAttribute("data-block")),f=c.length-1;0<=f;f--){var e=c[f];e.classList.contains("ai-delayed-"+
a)&&e.classList.remove("ai-delayed-unprocessed")}"undefined"==typeof ai_delay_tracking&&(ai_delay_tracking=0);ai_delay_tracking+=b;setTimeout(k,b,a)}}};setTimeout(ai_process_delayed_blocks,1)};
