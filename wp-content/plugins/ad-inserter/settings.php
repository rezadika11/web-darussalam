    ...
    <div class="ai-rounded">
      <table class="ai-settings-table ai-values" style="width: 100%;">
        ...
        <tr>
          ...
          <td>
            <select id="javascript-code" name="javascript-code" <?php echo get_wait_for_jquery () == AI_WAIT_FOR_JQUERY_ENABLED ? 'disabled ' : ''; ?>default="<?php echo DEFAULT_WAIT_FOR_JQUERY; ?>" title="<?php _e ('Inline means inserting JavaScript code in the footer of the page, File means loading external JavaScript file', 'ad-inserter'); ?>">
...
?>
    ...
    replace_blocked_image ('ai-ez-5',       'ez-5.jpg',             'block');
    replace_blocked_image ('ai-ez-6',       'ez-6.jpg',             'block');
    replace_blocked_image ('ai-ez-7',       'ez-7.png',             'block');
...
?>
      ...
      <div class="ai-form ai-rounded" style="height: 90px; padding: 8px 4px 8px 12px;">
        <a href='https://www.ezoic.com/humix-network/' class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-8" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-8.jpg" /></a>
      </div>
<?php
      break;
    case 7:
...
?>
      ...
      <div class="ai-form ai-rounded" style="height: 90px; padding: 8px 4px 8px 12px;">
        <a href='https://www.ezoic.com/' class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-6" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-6.jpg" /></a>
      </div>
<?php
      break;
...
<?php   break; case 3: ?>
            <a href="https://www.ezoic.com/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-5" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-5.jpg" /></a>
<?php   break;
      } ?>
          </div>
...
<?php   break;
        case 2:
        ?>
            <a href="https://www.ezoic.com/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-4" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-4.jpg" /></a>
<?php   break;
        case 3:
?>
<!--            <a href='https://adinserter.pro/documentation/ad-blocking-detection' class="clear-link" title="<?php _e ('Ad blocking detection and content protection', 'ad-inserter'); ?>" target="_blank"><img id="ai-adb" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ai-adb.png" /></a>-->
...
<!--            <a href='https://www.media.net/program?ha=e9Pw4uwo2Uw/5xjjsB3lnYZZWUI+hzRSONzDaYA9EwX+3jg/PJYwFshOFEjop5NH2wRNDfr357ZTY1zlhCk7zw%3D%3D&loc=2' class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-media-9" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>contextual-9.gif" /></a>-->
            <a href="https://www.ezoic.com/humix-network/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-7" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-7.png" /></a>
<?php   break; case 1: ?>
<!--            <a href="https://adinserter.pro/documentation/black-and-white-lists#geo-targeting" class="clear-link" title="Geotargeting - black/white-list countries" target="_blank"><img id="ai-pro-3" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ai-countries-250.png" /></a>-->
            <a href="https://underdogmedia.com/edge-publisher-adinserter/" class="clear-link" title="<?php _e ('Maximize Revenue', 'ad-inserter'); ?>" target="_blank"><img id="ai-um-2" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>um-2.png" /></a>
<?php   break; case 2: ?>
...
<?php   break;
        case 1:
        ?>
            <a href="https://www.ezoic.com/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-3" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-3.jpg" /></a>
<?php   break;
        case 2:
?>
            <a href='https://www.infolinks.com/publishers/?kid=3114832&loc=2' class="clear-link" title="<?php _e ('Use Infolinks ads with Adsense to earn more', 'ad-inserter'); ?>" target="_blank"><img id="ai-info-2" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>info-2.jpg" /></a>
